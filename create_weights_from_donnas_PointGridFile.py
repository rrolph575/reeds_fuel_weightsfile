...
census_without_country = census_without_country.to_crs(gdf.crs)
...
gdf = gdf.to_crs(census_boundaries_gdf.crs)  # Ensure both GeoDataFrames use the same CRS
...
#p_regions_by_cendiv = joined.groupby('index_right')['aggreg'].apply(list) 
